...
export default function ProjectsSection({ param }) {
  return (
    <aside className="proyectos-section">
      ...
      {param === "proyectos" ? (
        <>
          <img className="laterales lateral_izq" src="/flecha-gris.png"></img>
          <img className="laterales lateral_der" src="/flecha-gris.png"></img>
        </>
      ) : (
        <>
          <img className="laterales lateral_der" src="/laterales.png"></img>
          <img className="laterales lateral_izq" src="/laterales.png"></img>
        </>
      )}
    </aside>
  );
