...
import ContactFormScript from "./ContactFormScript"; // Importa el componente cliente
        ...
        <header>
          ...
          <picture>
            <Image
              width={330}
              height={330}
              src="/contact-page/Pet.png"
              alt="Mascota de Verdant"
            />
          </picture>
        </header>
          ...
          <div className="info-container">
            ...
            <div>
              <Image
                width={71}
                height={68}
                src="/contact-page/mail-icon.png"
                alt="Icono de correo"
              />
              <p>
